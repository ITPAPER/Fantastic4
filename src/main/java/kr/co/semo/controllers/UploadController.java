...
public class UploadController {
    ...
    public ModelAndView download(Model model, @RequestParam(value = "file") String filePath, @RequestParam(value="origin", required=false) String originName, 
            @RequestParam(value="size", required=false) String size, @RequestParam(value="crop", defaultValue="false") String crop) {
