...
<body>
 ...
 <!-- //상단 메뉴바 -->
   ...
   <div class="content">
      <div class="container">
         <h1 class="text-center">상가 매물수정 </h1>
         <p class="text-muted">▶등록된 매물은 60일간 노출되며, 매물 관리 규정에 위배되거나 신고된 매물은
            비공개 혹은 삭제 처리됩니다.</p>
         <!--//page title-->
         <!--main section 시작-->
         <div class="main_section">
            <form id="registerform" name="registerform" method="POST" action="${pageContext.request.contextPath}/maemul_update.ok"  enctype="multipart/form-data">
               <!-- 메물 번호 -->
               <input type="hidden" id="maemul_num" name="maemul_num" value="${output.maemul_num}" />
               <!-- 등록일 -->
               <input type="hidden" id="reg_date" name="reg_date" value="${Fileoutput[0].reg_date}"/>
               <!--위치정보-->
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="address_info">
                              <div class="button">
                                 <input type="text" name="item_addrst" id="item_addrst" readonly value="${output.item_addrst}"/> <input
                              ...
                              <div class="detailed_form">
                                 <textarea class="form-control" id="item_addrnd" name="item_addrnd"
                                    ...
                                    placeholder="상세주소를 입력하세요." required>${output.item_addrnd}</textarea>
                              </div>
                           </div>
                        </td>
                        <td>
                           <div class="map_box">
                              <div id="map"
                                 style="width: 400px; height: 200px;  position: absolute;"></div>
                           </div>
                        </td>
                     </tr>
                  </tbody>
                        ...
                        <td>
                           <div class="maemul_info">
                              ...
                              <div class="toggle-radio">
                                  <c:choose>
                                     <c:when test="${output.select_type eq 'Y'}">
                                        <input type="radio" class="radionon" name="rdo" id="yes" value="Y" checked />
                                       <input type="radio" class="radionon" name="rdo" id="no" value="N"/>
                                     </c:when>
                                     <c:otherwise>
                                        <input type="radio" class="radionon" name="rdo" id="yes" value="Y" />
                                       <input type="radio" class="radionon" name="rdo" id="no" value="N" checked/>
                                     </c:otherwise>
                                  </c:choose>
                                 <div class="switch">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    maxlength="50글자 이하로 입력하세요." data-val-length-max="50" 
                                    style="width: 400px; margin:15px;" value="${output.build_name}" required/>
                                 </td>
                              </tr>
                              <tr>
                                 <th>사진</th>
               ...
               <table class="info_article_three">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td>
                           <div class="deal_info">    
                               <input type="radio" id="button_rent" class="icheckuse" name="addmaemul"  value="Y" required checked/>&nbsp;월세 추가
                                <input type="radio" id="button_buy" class="icheckuse" name="addmaemul" value="N" />&nbsp;매매 추가
                                <c:choose>
                            <c:when test="${output.warrenty eq 0}">
                                ...
                                value="${output.sale}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;/
                                <input type="text" class="addtext" name="gideposit" placeholder="기보증금"
                                value="${output.pre_war}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;/
                                <input type="text" class="addtext" name="gimonthrent" placeholder="기월세"
                                value="${output.pre_month}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;만원&nbsp;&nbsp;(예: 5000)
                            </div>
                            </c:when>
                            <c:otherwise>
                                <div class="addrent" hidden="" style="margin-top:10px"><input type="text" class="addtext" name="deposit" id="deposit" placeholder="보증금"
                                value="${output.warrenty}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;/
                                <input type="text" class="addtext" name="monthrent" placeholder="월세"
                                value="${output.monthly}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;만원&nbsp;&nbsp;(예: 5000/100)</div>
                                <div class="addbuy" hidden="" style="margin-top:10px"><input type="text" name="buy" placeholder="매매가"
                                onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;/
                                <input type="text" class="addtext" name="gideposit" placeholder="기보증금"
                                onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;/
               ...
               <table class="info_article_four">
                  ...
                  <tbody>
                     ...
                     <div class="form-check" style="display: inline;">
                          <input type="checkbox" class="icheckuse"  name="select_check" id="validselect2" />
                       <label class="form-check-label" for="select_check">복층(연층)</label>
                        </div>            
                  <div class="form-check"  style="display: inline; margin-right:20px;">
                       <input type="checkbox" class="icheckuse" name="select_check" id="validselect3" />
                     ...
                     <th>계약면적</th>
                        <td>   
                           ...
                           <input type="text" class="form-control" id="maemulsize" name="maemulsize" maxlength="4"
                            value="${output.all_width}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>
                        ...
                        <td>
                           <div class="maemul_floors" style="width: 110px;">
                              <select class="form-control" id="validselect4" name="maemulfloors" required>
                               <option value="">--선택--</option>
                                 <option value="1">1층</option>
                                 <option value="2">2층</option>
                                 <option value="3">3층</option>
                        ...
                        <td>   
                           ...
                           <input type="text" class="form-control" id="maemulsize1" name="maemulsize1" maxlength="4"
                            value="${output.pri_width}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>
                           <span style="padding-top: 10px;">평</span></div>
                           <div class="maemul_size2" style="display: inline-flex;">
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="heat_info" style="width: 110px;">
                              <select class="form-control" id="validselect5" name="heatform" required>
                               <option value="">---선택---</option>
                           ...
                           <td>
                              <div class="toilet_form" style="width: 140px;">
                                 <select class="form-control" id="validselect6" name="toiletform" required>
                                  <option value="">---선택---</option>
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="year_form" style="display: inline-block; margin: 20px; width: 110px;">
                                 <select class="form-control" id="validselect7" name="yearform" required>
                                  <option value="">---선택---</option>
                                 ...
                                 <select class="form-control" id="validselect8" name="monthform" required>
                                  <option value="">---선택---</option>
                        ...
                        <div class="movein_day">
                           <c:choose>
                              <c:when test="${output.movein eq 'Y' }">
                              ...
                              <c:otherwise>
                              <input type="radio" class="icheckuse" name="nowbtn" id="nowbtn" value="Y"/>&nbsp;즉시입주
                                   <input type="radio" class="icheckuse" name="nowbtn" id="withbtn" value="N" checked/>&nbsp;협의가능
                              </c:otherwise>
                           </c:choose>
                        ...
                        <tbody>
                             <tr>
                               ...
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                     <div class="foregift_chk"  style="margin : 15px 20px;">      
                                      <input type="radio" id="foregiftchk" class="icheckuse"  name="foregiftchk" value="yes" checked/>&nbsp;있음 
                                      <input type="radio" class="icheckuse" name="foregiftchk" value="no"  />&nbsp;없음
                                       <div class="foregift" hidden="" style="margin-top:10px"><input type="text" class="foregifttext" name="foregift" placeholder="권리금"
                                        value="${output.premium}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;만원&nbsp;&nbsp;(예: 1000)</div>
                                     </div>
                                  </c:otherwise>
                               </c:choose>
                               </td>
                               ...
                               <c:choose>
                                     ...
                                     <c:otherwise>
                                        <div class="manage_chk" style="margin : 15px 20px;">
                                         <input type="radio" class="icheckuse" id="managechk" name="managechk" id="managechk" value="yes" checked/>&nbsp;있음
                                          <input type="radio" class="icheckuse" name="managechk" id="manage1" value="no"/>&nbsp;없음
                                           <div class="manage" hidden="" style="margin-top:10px"><input type="text" class="managetext" name="manage" placeholder="관리비"
                                            value="${output.manage_ex}" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')"/>&nbsp;만원&nbsp;&nbsp;(예: 1000)</div>
                                        </div>
                                     </c:otherwise>
                               </c:choose>
                               </td>
                               ...
                               <div class="park_chk" style="margin : 15px 20px;">
                                  <c:choose>
                                     ...
                                     <c:otherwise>
                                        <input type="radio" class="icheckuse" name="parkchk" id="parkchk" value="yes" checked/>&nbsp;가능
                                          <input type="radio" class="icheckuse" name="parkchk" id="parkchk" value="no"/>&nbsp;불가능
                                     </c:otherwise>
                                  </c:choose>
                                 <div class="parkuse" hidden=""style="margin-top:10px; width:110px;" ><select class="form-control" id="validselect9" name="parkuse" required>
                               ...
                               <div class="eleva_chk" style="margin : 15px 20px;">
                                     <c:choose>
                                           ...
                                           <c:otherwise>
                                              <input type="radio" class="icheckuse" name="elevachk" id="elevachk" value="yes" checked/>&nbsp;있음
                                             <input type="radio" class="icheckuse" name="elevachk" id="elevachk1" value="no"/>&nbsp;없음
                                           </c:otherwise>
                                     </c:choose>
                                     <div class="elevause" hidden=""style="margin-top:10px; width:110px;" ><select class="form-control" id="validselect10" name="elevause" required>
                                     <option value="0">-선택하세요-</option>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td>
                           ...
                           value="${output.title}" maxlength="50글자 이하로 입력하세요." data-val-length-max="50" style="width: 850px; margin: 20px; margin-left:40px;" required/>
                        </td>
                        <tr>
                        <th>상세설명</th>
                        <td>
                           <div class="detailed_explain">
                                 ...
                                 placeholder="상세설명을 입력하세요." required>${output.content}</textarea>
                           </div>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td>
                           ...
                           value="${output.hidden}" maxlength="50글자 이하로 입력하세요." data-val-length-max="50" style="width: 850px; margin: 20px; margin-left:40px;" required/>
                        </td>
                     </tr>
    ...
    <!-------------------------datepicker 시작------------------------------->
        $(function() {
           $("#datepicker").datepicker({
            ...
            // 계약면적, 전용면적 value 처리 구간
            $(function() {
               // 소수점의 자리수 제한 
               $("#maemulsize2").val(($("#maemulsize").val() * 3.3).toFixed(2));
               $("#maemulsize3").val(($("#maemulsize1").val() * 3.3).toFixed(2));
         });
            // 계약면적, 전용면적 value 처리 구간 end 
...
$ (document) .ready (function () { 
  ...
  // 월세/매매 종류 선택 
  if ("${output.select_sale}" == 'Y') {
     $('#button_rent').iCheck('check');
     $(".addrent").show();
  } else {
     $('#button_buy').iCheck('check');
     $(".addbuy").show();
  }
...
<!-- //icheck  -->
   ...
   <script>
      ...
      mapOption = {
         center : new daum.maps.LatLng("${output.latitude}", "${output.longitude}"), // 지도의 중심좌표
         level : 5
      // 지도의 확대 레벨
      };
      ...
      var markerPosition = new kakao.maps.LatLng("${output.latitude}", "${output.longitude}");
      ...
      var marker = new daum.maps.Marker({
         position : new daum.maps.LatLng("${output.latitude}", "${output.longitude}"),
         map : map
      });
   ...
   <script>
   <!----------------select value 추가 처리 하는곳 ------------------------------------------->  
   $(function() {      
       
     // 태그를 하나하나가져옴
     // 층수 
     $('#validselect option').each(function() {
        console.log($(this).val());
      // 중간에 멈춤? 
      if($(this).val() == '${output.floor}') {
         console.log("awe" + $(this).val())
         $(this).attr("selected", "selected");;
      }
   });
    // 건물층수  
   $('#validselect4 option').each(function() {
      if($(this).val() == '${output.all_floor}')
         $(this).attr("selected", "selected");
   });
   // 난방종류 
   $("#validselect5 option").each(function() {
      if($(this).val() == '${output.heating}') {
         $(this).attr("selected", "selected");
      }
   });
   
   // 화장실  
   $("#validselect6 option").each(function() {
      if($(this).val() == '${output.toilet}') {
         $(this).attr("selected", "selected");
      }
   });
   
   // 준공년도(년도)
   $("#validselect7 option").each(function() {
      if($(this).val() == '${output.comple_year}') {
         $(this).attr("selected", "selected");
      }
   ...
   // 주차 
   $("#validselect9 option").each(function() {
      if($(this).val() == '${output.parking}') {
         $(this).attr("selected", "selected");
      }
   });
   
   // 엘리베이터 
   $("#validselect10 option").each(function() {
      if($(this).val() == '${output.parking}') {
         $(this).attr("selected", "selected");
      }
   });
